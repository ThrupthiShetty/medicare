...
import { AppMediaType, InConfiguration } from "../../models/config.interface";
...
export class ConfigService {
  ...
  public mediaConfigs: AppMediaType[] = [];
  ...
  setConfigData() {
    ...
    this.mediaConfigs=[{ id: "country_flag", url: "assets/imgs/f/us.jpg" }];
  }
}
