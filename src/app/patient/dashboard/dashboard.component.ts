...
export class DashboardComponent implements OnInit {
  ...
  public radialChartOptions: Partial<radialChartOptions> | any;
  public restRateChartOptions: Partial<restRateChartOptions> | any;
  public performanceRateChartOptions: Partial<performanceRateChartOptions> | any;

  eobRequested:Boolean = false;
