...
export const ROUTESBP: RouteInfo[] = [


  // Admin Modules
  {
    path: "/admin/main/dashboarda",
    title: "Home",
  ...
  },
  {
    ...
    role: ["Admin"],
    submenu: [ {
      path: "/admin/main/patient-profile",
